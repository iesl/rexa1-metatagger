...
public class BufferedPipedOutputStream extends OutputStream {
  ...
  private BufferedPipedInputStream sink;
   ...
   */
  public BufferedPipedOutputStream(BufferedPipedInputStream snk) throws IOException {
    connect( snk );
  }
   ...
   * @throws IOException if an I/O error occurs.
   */
  public synchronized void connect(BufferedPipedInputStream snk) throws IOException {
    if (snk == null) {
